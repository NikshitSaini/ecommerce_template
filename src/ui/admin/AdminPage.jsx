...
import {
    ...
    Banknote, ShieldCheck, Box, Package, X, LogOut
} from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-500">Welcome back, here's what's happening today across your store.</p>
            </div>
                    ...
                    >
                        {monthlyRevenue.length > 0 ? (
                            <div className="h-[400px] w-full mt-4" style={{ minHeight: '400px' }}>
                                <Charts.ResponsiveContainer width="100%" height="100%" minWidth={1} minHeight={1}>
                                    <Charts.BarChart
                                        data={monthlyRevenue}
                        ...
                        <div className="space-y-6 mt-4">
                            {productPerformance.length > 0 ? (
                                productPerformance.map((product, index) => {
                                    const maxQty = productPerformance[0].quantity || 1;
                                    ...
                                    return (
                                        <div key={index} className="space-y-2">
                                            <div className="flex justify-between items-center text-sm">
                                                <span className="text-gray-600 font-medium truncate pr-2 max-w-[200px]">{product.name}</span>
                                                <span className="text-gray-900 font-bold shrink-0">{product.quantity} sold</span>
                                            </div>
                                ...
                                <p className="text-center py-6 text-gray-500 text-sm">No sales data available</p>
                            )}
                        </div>
                        <div className="mt-8">
                            <Link to="/admin/products" className="block text-center w-full py-3 bg-gray-50 text-gray-600 text-sm font-bold rounded-xl hover:bg-gray-100 transition-colors">
                                View Inventory
                            </Link>
                        </div>
                    </Card>
                ...
                {(sidebarOpen || mobileMenuOpen) && (
                    <>
                        ...
                        <motion.div
                            ...
                            className={`
                                ${mobileMenuOpen ? 'fixed left-0 top-0 bottom-0 z-50 shadow-2xl' : 'hidden lg:flex shrink-0'}
                                w-72 bg-white border-r border-gray-100 flex-col
                            `}
                        >
                            {/* Logo */}
                            ...
                            <div className="p-4 border-t border-gray-50 bg-white mt-auto">
