        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-4">
                <div>
                    ...
                    <p className="text-slate-500 font-medium">Manage your inventory, pricing, and availability.</p>
                </div>
                                        ...
                                        <td className="py-6 px-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[12px] font-bold text-slate-400 uppercase tracking-widest">{product.brand || 'General'}</p>
                                                </div>
                                            </div>
                                        </td>
